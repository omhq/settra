...
CUBE_QUERY_CONTINUE_WAIT_ATTEMPTS = int(
    os.getenv("CUBE_QUERY_CONTINUE_WAIT_ATTEMPTS", "8")
)
CUBE_QUERY_CONTINUE_WAIT_SLEEP_SECONDS = float(
    os.getenv("CUBE_QUERY_CONTINUE_WAIT_SLEEP_SECONDS", "1")
)
