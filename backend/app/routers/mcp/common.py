...
mcp_server = FastMCP(
    ...
    instructions=(
        ...
        "requirement. Do not create, update, or delete semantic overlays unless "
        "the user has explicitly requested or approved the change. Before "
        "creating or updating an overlay, validate its source fields, grain, join "
