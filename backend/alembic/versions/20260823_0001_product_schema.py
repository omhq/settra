...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "plugin = 'googlesheets'", name="ck_connections_google_sheets"
        ),
        schema=SCHEMA,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["connection_id"], [f"{SCHEMA}.connections.id"], ondelete="CASCADE"
        ),
        schema=SCHEMA,
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["collection_id"], [f"{SCHEMA}.collections.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["pipe_id"], [f"{SCHEMA}.connections.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("collection_id", "pipe_id"),
        schema=SCHEMA,
    )
    op.create_index(
        "idx_collection_pipes_pipe", "collection_pipes", ["pipe_id"], schema=SCHEMA
    )
    op.create_table(
        "oauth_clients",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["client_id"], [f"{SCHEMA}.oauth_clients.client_id"], ondelete="CASCADE"
        ),
        schema=SCHEMA,
    )
    op.create_table(
    ...
    op.create_index(
        "idx_mcp_requests_created_at",
        "mcp_requests",
        [sa.text("created_at DESC")],
        schema=SCHEMA,
    )
    op.create_index(
        "idx_mcp_requests_status", "mcp_requests", ["status"], schema=SCHEMA
    )
